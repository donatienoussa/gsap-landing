<div align="center">
  <br />
    <a href="https://gsap-landing-wheat.vercel.app/" target="_blank">
...
- **[Nextjs](https://next.dev/)** is a React framework for building interactive UIs. It provides the component structure for modular development, allowing smooth integration of GSAP animations, reusable logic for scroll behavior, and support for responsive layout and state-driven UI features like carousels and video sections.
...
```bash
git clone https://github.com/donatienoussa/gsap-landing.git
cd gsap_cocktails
```
